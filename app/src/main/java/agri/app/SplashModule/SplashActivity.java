...
import agri.app.R;
import agri.app.RegLogActivity;
...
public class SplashActivity extends AppCompatActivity implements ViewSwitcher.ViewFactory {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            hTextView.animateText("Agri App");
            int secondsDelayed = 1;
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    startActivity(new Intent(SplashActivity.this, RegLogActivity.class));
                    finish();
